...
<div class="about-top-banner top-banner" style="background:url(/pc/Public/Static/images/solution-banner.jpg) center no-repeat; height:354px;"></div>
<div class="middle">
...
<div class="product-content">
       <ul>
        <li class="p1"> <a href="solution-solution_department.html" >
          <img src="/pc/Public/Static/images/solution/list-01.jpg"  width="220" height="220" alt="综合百货行业" style="padding:30px 40px"/>
          </a>
          <dl>
            <dt>综合百货行业</dt>
            <dd>
		...
		<li class="p1"> <a href="solution.html" >
          <img src="/pc/Public/Static/images/solution/list-05.jpg"  width="220" height="220" alt="汽车行业" style="padding:30px 40px"/>
          </a>
          <dl>
            <dt>生鲜行业</dt>
            <dd>
          ...
          <img src="/pc/Public/Static/images/solution/list-06.jpg"  width="220" height="220" alt="母婴行业" style="padding:30px 40px"/>
          </a>
          <dl>
            <dt>母婴行业</dt>
            <dd>
		...
		<li class="p3"> <a href="solution-solution_crossborder5.html" >
          <img src="/pc/Public/Static/images/solution/list-07.jpg"  width="220" height="220" alt="医药行业" style="padding:30px 40px"/>
          </a>
          <dl>
            <dt>数码行业</dt>
            <dd>
...
<script src="/pc/Public/Static/js/jquery.carousel.js" ></script> 
<script src="/pc/Public/Static/js/lightbox.min.js" ></script> 
