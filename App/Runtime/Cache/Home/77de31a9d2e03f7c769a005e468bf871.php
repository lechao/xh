...
<h2>电商系统移动应用</h2>
 ...
 <div class="app-con-tit">
    <p class="banner-info">需要iOS7.0或更高版本。与iPhone、iPad、iPod touch兼容。此APP已针对iPhone5、iPhone6和iPhone6 Plus优化。</p>
  </div>
  ...
  <div class="app-con">
    ...
    <img class="qcode child-tab-show" src="image/ShopNC_PHP_iOS.png" tppabs="http://www.shopnc.net/wap/image/ShopNC_PHP_iOS.png"  width="100%" height="auto" alt="ShopNC电商系统移动应用,iPhone手机客户端,扫描二维码,下载iOS移动端体验版"/>
    <img class="qcode child-tab-show hide" src="image/ShopNC_Java_iOS.png" tppabs="http://www.shopnc.net/wap/image/ShopNC_Java_iOS.png"  width="100%" height="auto" alt="ShopNC电商系统移动应用,安卓手机客户端,扫描二维码,下载JaVa版Android移动端体验版"/>
   <!--  <span class="qcode child-tab-show hide"><img src="image/ShopNC_Java_iOS.png"  width="100%" height="auto" alt="ShopNC电商系统移动应用,安卓手机客户端,扫描二维码,下载JaVa版Android移动端体验版" /></span>-->
