...
<div class="clear"></div>
    ...
    <form>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
            <tr>
                <th width="80">登录邮箱：</th>
                <td><input name="admin[email]" type="text" class="input" size="30" /></td>
            </tr>
            <tr>
                <th width="80">新密码：</th>
            ...
            <tr>
                ...
                <td>
                    <select name="admin[role_id]">
                        <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><option value="<?php echo ($role['id']); ?>" <?php if($role['pid'] == 0): ?>disabled="true"<?php endif; ?>><?php echo ($role['fullname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                <th width="80">备注信息：</th>
                <td><textarea class="jq_watermark" rows = "5" cols="68" name="admin[remark]" placeholder="管理员备注信息"></textarea></td>
            </tr>
        </table>
    </form>
...
$(".submit").click(function(){
    commonAjaxSubmit("<?php echo U('Admins/create');?>");
    return false;
});
</script>
