...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <ul>
            ...
            <div id="Right">
                <div class="Item hr">
    <span class="fr">现有角色<b><?php echo ($rows_count); ?></b>个</span>
...
<form>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
        ...
        <tbody>
            <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><tr align="center">
                <td align="left"><?php echo ($role['fullname']); ?></td>
                <td><?php echo ($role['description']); ?></td>
                <td><?php if($role['status'] == 1): ?>已启用<?php else: ?>已禁用<?php endif; ?></td>
                <td>[ <a href="<?php echo U('Roles/edit', array('id' => $role['id']));?>">编辑</a> ] <?php if(($role['id'] != $_SESSION['current_account']['role_id']) && ($role['pid'] != 0)): ?>[ <a href="<?php echo U('Roles/assignAccess', array('id' => $role['id']));?>">分配权限</a> ]<?php endif; ?></td>
