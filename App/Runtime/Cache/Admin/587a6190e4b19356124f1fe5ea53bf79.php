...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/xh/Public/Min/?f=/xh/Public/stylesheets/admin/base.css|/xh/Public/javascripts/admin/asyncbox/skins/default.css" />
</head>

<body class="loginWeb">
    <div class="loginBox">
        <div class="innerBox">
            <div class="logo"> <img src="/xh/Public/images/admin/logo.png" /></div>
            <form>
                <div class="loginInfo">
                    <ul>
    ...
    <script type="text/javascript" src="/xh/Public/Min/?f=/xh/Public/javascripts/admin/jquery-1.7.2.min.js|/xh/Public/javascripts/admin/jquery.lazyload.js|/xh/Public/javascripts/admin/functions.js|/xh/Public/javascripts/admin/base.js|/xh/Public/javascripts/admin/jquery.form.js|/xh/Public/javascripts/admin/asyncbox/asyncbox.js|/xh/Public/javascripts/admin/jquery.watermark.js|/xh/Public/javascripts/admin/datepicker/datetimepicker_css.js">
</script>
