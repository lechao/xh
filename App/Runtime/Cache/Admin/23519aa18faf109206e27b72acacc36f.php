...
<div class="clear"></div>
    ...
    <div class="Item hr">
        <div class="current">添加角色</div>
    </div>
    <form>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
            <tr>
                <th width="80">角色名称：</th>
                <td><input name="role[name]" type="text" class="input" size="30" /></td>
            </tr>
            <tr>
                <th width="80">父角色：</th>
                <td>
                    <select name="role[pid]">
                        <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><option value="<?php echo ($role['id']); ?>"><?php echo ($role['fullname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th width="80">角色描述：</th>
                <td><textarea class="jq_watermark" rows = "5" cols="68" name="role[description]" placeholder="角色描述"></textarea></td>
            </tr>
        </table>
    </form>
...
$(".submit").click(function(){
    commonAjaxSubmit("<?php echo U('Roles/create');?>");
    return false;
});
</script>
