...
<div class="clear"></div>
    ...
    <div class="subMenuList">
        ...
        <ul>
            ...
            <!-- right -->
            <div id="Right">
                <script type="text/javascript" src="/pc/Public/javascripts/admin/kindeditor/kindeditor.js"></script>
<script type="text/javascript" src="/pc/Public/javascripts/admin/kindeditor/lang/zh_CN.js"></script>

<div class="Item hr">
    <div class="current">编辑数据</div>
</div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1" id="form_inputs">
   <?php if(is_array($inputs)): $i = 0; $__LIST__ = $inputs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$input): $mod = ($i % 2 );++$i;?><tr>
    ...
    <input type="hidden" name="<?php echo ($hidden['name']); ?>" value="<?php echo ($hidden['value']); ?>" />
</table>
...
<script type="text/javascript">
formSubmit("<?php echo U(CONTROLLER_NAME . '/update');?>");
</script>
